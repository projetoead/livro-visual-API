...
var map = {
	"./pages/atividades/minhas-atividades/minhas-atividades.module": [
		"./src/app/pages/atividades/minhas-atividades/minhas-atividades.module.ts",
		"pages-atividades-minhas-atividades-minhas-atividades-module"
	],
	"./pages/atividades/nova-atividade/nova-atividade.module": [
		"./src/app/pages/atividades/nova-atividade/nova-atividade.module.ts",
		"default~pages-atividades-nova-atividade-nova-atividade-module~pages-atividades-responder-atividade-r~21328634",
		"pages-atividades-nova-atividade-nova-atividade-module"
	],
	"./pages/atividades/responder-atividade/responder-atividade.module": [
...
module.exports = "<ion-app>\r\n    <ion-split-pane>\r\n        <ion-menu type=\"overlay\">\r\n            <ion-header>\r\n                <ion-toolbar>\r\n                    <ion-title>Menu</ion-title>\r\n                </ion-toolbar>\r\n            </ion-header>\r\n            <ion-content>\r\n                <ion-list>\r\n                    <ion-menu-toggle auto-hide=\"false\" *ngFor=\"let p of appPages\">\r\n                        <ng-template [ngIf]=\"p.url\">\r\n                            <ion-item [routerDirection]=\"'root'\" [routerLink]=\"[p.url]\">\r\n                                <ion-icon slot=\"start\" [name]=\"p.icon\"></ion-icon>\r\n                                <ion-label>\r\n                                    {{p.title}}\r\n                                </ion-label>\r\n                            </ion-item>\r\n                        </ng-template>\r\n                        <ng-template [ngIf]=\"!p.url\">\r\n                            <ion-item (click)=\"acaoMenu(p.action)\" [routerLink]=\"\">\r\n                                <ion-icon slot=\"start\" [name]=\"p.icon\"></ion-icon>\r\n                                <ion-label>\r\n                                    {{p.title}}\r\n                                </ion-label>\r\n                            </ion-item>\r\n                        </ng-template>\r\n                    </ion-menu-toggle>\r\n                </ion-list>\r\n            </ion-content>\r\n        </ion-menu>\r\n        <ion-router-outlet main></ion-router-outlet>\r\n    </ion-split-pane>\r\n</ion-app>"
...
module.exports = "<ion-header>\r\n    <ion-toolbar>\r\n        <div [class.cabecalho-modal]=\"formCadastro\">\r\n            <div (click)=\"alternarForm()\" *ngIf=\"formCadastro\" class=\"modal-fechar\">\r\n                <ion-icon slot=\"icon-only\" name=\"arrow-back\"></ion-icon> Voltar\r\n            </div>\r\n            <div class=\"modal-fechar\">\r\n                <div (click)=\"dismiss()\">\r\n                    <ion-icon slot=\"icon-only\" name=\"close\"></ion-icon>\r\n                </div>\r\n                <!-- <ion-button (click)=\"dismiss()\" color=\"light\">\r\n                </ion-button> -->\r\n            </div>\r\n        </div>\r\n    </ion-toolbar>\r\n</ion-header>\r\n\r\n<ion-content>\r\n    <div class=\"form-login\" *ngIf=\"!formCadastro\">\r\n        <form [formGroup]=\"usuarioForm\">\r\n            <ion-text color=\"dark\">\r\n                <h1 class=\"logar-h1\">Logar</h1>\r\n            </ion-text>\r\n            <ion-item>\r\n                <ion-label position=\"floating\">E-mail</ion-label>\r\n                <ion-input type=\"email\" formControlName=\"email\"></ion-input>\r\n            </ion-item>\r\n            <ion-item>\r\n                <ion-label position=\"floating\">Senha</ion-label>\r\n                <ion-input type=\"password\" formControlName=\"senha\"> </ion-input>\r\n            </ion-item>\r\n            <div class=\"botoes\">\r\n                <ion-button (click)=\"logar()\" size=\"full\" [disabled]=\"!usuarioForm.valid\">\r\n                    Entrar\r\n                </ion-button>\r\n                <!-- <ion-button (click)=\"onClick()\">\r\n                    Cadastrar\r\n                </ion-button> -->\r\n            </div>\r\n            <ion-text color=\"dark\" class=\"ion-text-center\">\r\n                <p class=\"cadastrar\">Criar uma Conta? <b (click)=\"alternarForm()\">Cadastrar</b></p>\r\n            </ion-text>\r\n        </form>\r\n    </div>\r\n    <div class=\"form-login\" *ngIf=\"formCadastro\">\r\n        <form [formGroup]=\"cadastroForm\">\r\n            <ion-text color=\"dark\">\r\n                <h1 class=\"logar-h1\">Cadastrar</h1>\r\n            </ion-text>\r\n            <div class=\"avatar\">\r\n                <div>\r\n                    <ion-avatar item-center>\r\n                        <img [src]=\"imagem.baixa_resolucao || 'assets/images/person.png'\">\r\n                    </ion-avatar>\r\n                </div>\r\n                <input type=\"file\" src=\"\" accept=\"image/*\" multiple=\"false\" id=\"imagePicker\" hidden\r\n                    (change)=\"abreArquivo($event)\">\r\n                <ion-button (click)=\"selecionarImagem()\" color=\"light\" shape=\"round\" size=\"small\">\r\n                    {{ !imagem.baixa_resolucao ? \"Selecionar\" : \"Alterar\" }}\r\n                </ion-button>\r\n            </div>\r\n            <ion-item>\r\n                <ion-label position=\"floating\">Nome Completo</ion-label>\r\n                <ion-input type=\"text\" formControlName=\"nome\"></ion-input>\r\n            </ion-item>\r\n            <ion-item>\r\n                <ion-label position=\"floating\">E-mail</ion-label>\r\n                <ion-input type=\"email\" formControlName=\"email\"></ion-input>\r\n            </ion-item>\r\n            <ion-item>\r\n                <ion-label position=\"floating\">Senha</ion-label>\r\n                <ion-input type=\"password\" formControlName=\"senha\"> </ion-input>\r\n            </ion-item>\r\n            <ion-item>\r\n                <ion-label position=\"floating\">Repetir Senha</ion-label>\r\n                <ion-input type=\"password\" formControlName=\"repetirSenha\"> </ion-input>\r\n            </ion-item>\r\n            <div class=\"botoes\">\r\n                <ion-button (click)=\"cadastrar()\" size=\"full\"\r\n                    [disabled]=\"!cadastroForm.valid || cadastroForm.value.senha != cadastroForm.value.repetirSenha\">\r\n                    Cadastrar\r\n                </ion-button>\r\n            </div>\r\n        </form>\r\n    </div>\r\n</ion-content>"
...
var routes = [
    ...
    { path: 'atividades/minhas-atividades', loadChildren: './pages/atividades/minhas-atividades/minhas-atividades.module#MinhasAtividadesPageModule' },
    { path: 'atividades/nova-atividade', loadChildren: './pages/atividades/nova-atividade/nova-atividade.module#NovaAtividadePageModule' },
    { path: 'atividades/responder-atividade/:id', loadChildren: './pages/atividades/responder-atividade/responder-atividade.module#ResponderAtividadePageModule' }
];
...
/* harmony import */ var _services_banco_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./services/banco.service */ "./src/app/services/banco.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _app_pages_login_login_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../app/pages/login/login.page */ "./src/app/pages/login/login.page.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(alertCtrl, modalCtrl, router, platform, splashScreen, statusBar, bancoLocal) {
    ...
    AppComponent.prototype.buscarUsuario = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                return [2 /*return*/, new Promise(function (done) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        var user;
                        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            switch (_a.label) {
                                        ...
                                        this.appPages = this.appPages.concat([
                                            {
                                                ...
                                                url: '/atividades/minhas-atividades',
                                                icon: 'folder'
                                            },
                                            {
                                                title: 'Sair',
    ...
    AppComponent.prototype.acaoMenu = function (acao) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert_1, modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(acao == 'sair')) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.alertCtrl.create({
                                subHeader: "Deseja sair da sua conta?", buttons: [{
                                        text: "Não"
                                    }, {
                                        text: "Sim",
                                        handler: function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                                switch (_a.label) {
                                                    case 0: return [4 /*yield*/, this.bancoLocal.remove('user-credentials')];
                                                    case 1:
                                                        _a.sent();
                                                        return [4 /*yield*/, this.buscarUsuario()];
                                                    case 2:
                                                        _a.sent();
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 4];
                    case 2:
                        if (!(acao == 'logar')) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.modalCtrl.create({ component: _app_pages_login_login_page__WEBPACK_IMPORTED_MODULE_7__["LoginPage"], cssClass: 'modal-pequeno' })];
                    case 3:
                        modal = _a.sent();
                        modal.present();
                        modal.onDidDismiss().then(function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                            ...
                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this.buscarUsuario()];
                                    case 1:
                                        user = _a.sent();
                                        if (user)
    ...
    AppComponent.ctorParameters = function () { return [
        ...
        { type: _services_banco_service__WEBPACK_IMPORTED_MODULE_5__["BancoService"] }
    ]; };
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"],
            ...
            _services_banco_service__WEBPACK_IMPORTED_MODULE_5__["BancoService"]])
    ], AppComponent);
    return AppComponent;
}());
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                _pages_login_login_module__WEBPACK_IMPORTED_MODULE_9__["LoginPageModule"]
            ],
            providers: [
...
module.exports = ".form-login {\n  padding: 10px 20px;\n}\n.form-login .avatar {\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n          flex-direction: column;\n}\n.form-login .avatar div {\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-pack: center;\n          justify-content: center;\n}\n.cabecalho-modal {\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-pack: justify;\n          justify-content: space-between;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _services_banco_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../../services/banco.service */ "./src/app/services/banco.service.ts");
...
var LoginPage = /** @class */ (function () {
    function LoginPage(bancoLocal, formBuilder, toastCtrl, modalCtrl, loadingCtrl, alertCtrl, platform, api) {
        this.bancoLocal = bancoLocal;
        ...
        this.platform = platform;
        this.api = api;
        this.url = "https://livro-visual.herokuapp.com/graphql";
        this.opts = {
            method: "POST",
        ...
        this.cadastroForm = formBuilder.group({
            nome: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].minLength(10)])],
            email: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].email])],
            senha: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].minLength(6)])],
            repetirSenha: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required]
        });
    }
    ...
    LoginPage.prototype.logar = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.loadingCtrl.create({ message: "Verificando credenciais..." })];
                    case 1:
                        loading = _a.sent();
                        loading.present();
                    ...
                    case 2:
                        retorno = _a.sent();
                        loading.dismiss();
                        if (!(!retorno.errors && retorno.data.logIn)) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.bancoLocal.set("user-credentials", retorno.data.logIn)];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.toastCtrl.create({ message: "Login realizado com sucesso", duration: 3000 })];
                    case 4:
                        toast = _a.sent();
                        toast.present();
                        this.dismiss();
                        return [3 /*break*/, 7];
                    case 5: return [4 /*yield*/, this.alertCtrl.create({ header: "Erro", message: "Credenciais incorretas, verifique e tente novamente" })];
                    case 6:
                        alerta = _a.sent();
                        alerta.present();
                        _a.label = 7;
    ...
    LoginPage.prototype.cadastrar = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var loading, body, retorno, toast, alerta, alerta;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.loadingCtrl.create({ message: "Cadastrando..." })];
                    case 1:
                        loading = _a.sent();
                        loading.present();
                        body = "\n            mutation{\n                signUp(\n                    email: \"" + this.cadastroForm.value.email + "\",\n                    password: \"" + this.cadastroForm.value.senha + "\",\n                    name: \"" + this.cadastroForm.value.nome + "\",\n                    baixa_resolucao: \"" + this.imagem.baixa_resolucao + "\",\n                    nivel_acesso: " + this.nivel_acesso + "\n                ){\n                    id\n                }\n            }\n        ";
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 8];
                    case 4:
                        if (!(retorno.errors && retorno.errors[0].message == "validation")) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.alertCtrl.create({ header: "Erro", message: "E-mail já utilizado." })];
                    case 5:
                        alerta = _a.sent();
                        alerta.present();
                        return [3 /*break*/, 8];
                    case 6: return [4 /*yield*/, this.alertCtrl.create({ header: "Ocorreu um erro", message: "Tente novamente, ou contate o suporte." })];
                    case 7:
                        alerta = _a.sent();
                        alerta.present();
                        _a.label = 8;
    ...
    LoginPage.prototype.alternarForm = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    LoginPage.prototype.selecionarImagem = function () {
    ...
    LoginPage.prototype.abreArquivo = function (e) {
        var _this = this;
        ...
        reader.onload = function (e) {
            ...
            image.onload = function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                var canvas, ctx, canvasOriginal, ctx2;
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    canvas = document.createElement('canvas'), ctx = canvas.getContext('2d');
                    canvas.width = 175;
                    canvas.height = 175;
                    ctx.drawImage(image, 0, 0, 175, 175);
                    canvasOriginal = document.createElement('canvas'), ctx2 = canvasOriginal.getContext('2d');
                    canvasOriginal.width = image.naturalWidth;
                    canvasOriginal.height = image.naturalHeight;
                    ctx2.drawImage(image, 0, 0, canvasOriginal.width, canvasOriginal.height);
                    this.imagem.baixa_resolucao = canvas.toDataURL("image/jpeg", 0.3);
                    return [2 /*return*/];
                });
            }); };
        };
    ...
    LoginPage.prototype.abreImagemCapacitor = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var image, imageUrl, image2;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        image2 = new Image();
                        image2.src = 'data:image/jpeg;base64,' + image.base64String;
                        image2.onload = function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                            var canvas, ctx, canvasOriginal, ctx2;
                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                canvas = document.createElement('canvas'), ctx = canvas.getContext('2d');
                                canvas.width = 175;
                                canvas.height = 175;
                                ctx.drawImage(image2, 0, 0, 175, 175);
                                canvasOriginal = document.createElement('canvas'), ctx2 = canvasOriginal.getContext('2d');
                                canvasOriginal.width = image2.naturalWidth;
                                canvasOriginal.height = image2.naturalHeight;
                                ctx2.drawImage(image2, 0, 0, canvasOriginal.width, canvasOriginal.height);
                                this.imagem.baixa_resolucao = canvas.toDataURL("image/jpeg", 0.3);
                                return [2 /*return*/];
                            });
                        }); };
    ...
    LoginPage.ctorParameters = function () { return [
        { type: _services_banco_service__WEBPACK_IMPORTED_MODULE_2__["BancoService"] },
    ...
    LoginPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_banco_service__WEBPACK_IMPORTED_MODULE_2__["BancoService"],
...
var CURRENT_URL_API = 'https://livro-visual.herokuapp.com';
var ApiService = /** @class */ (function () {
    function ApiService(http) {
        this.http = http;
    }
    ApiService.prototype.post = function (body) {
        var _this = this;
        return new Promise(function (done) {
            console.log('body: ', body);
            var hdrs = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
            var data = null;
            _this.http.post(CURRENT_URL_API + '/graphql', body, { headers: hdrs }).subscribe(function (dados) {
                data = dados;
    ...
    ApiService.prototype.get = function (body) {
        var _this = this;
        if (body === void 0) { body = ''; }
        return new Promise(function (done) {
            var hdrs = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
            var data = null;
            _this.http.get(CURRENT_URL_API + '/graphql?query=' + body, { headers: hdrs }).subscribe(function (dados) {
...
var BancoService = /** @class */ (function () {
    ...
    BancoService.prototype.set = function (key, value) {
        var _this = this;
        return new Promise(function (done) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var data;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Storage.set(data)];
                    case 1:
                        _a.sent();
                        done(data);
                        return [2 /*return*/];
    ...
    BancoService.prototype.get = function (key) {
        var _this = this;
        return new Promise(function (done) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var data;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = _a.sent();
                        done(JSON.parse(data.value));
                        return [2 /*return*/];
                }
            });
        }); });
    };
    BancoService.prototype.remove = function (key) {
        var _this = this;
        return new Promise(function (done) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
...
module.exports = __webpack_require__(/*! C:\Users\User\Documents\Yuri\livro-visual-APP\src\main.ts */"./src/main.ts");
